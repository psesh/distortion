...
def areaWeightedAvg(data, hubRadius, casingRadius):
    ...
    :param data: Pandas dataframe of pressure rake data as generated by csvToArray.py
...
def circumferentialAverage(data):
...
if __name__ == "__main__":
    ...
    if whichType == '3':
        ...
        print(
            'Area weighted average pressure: ' + str(areaWeightedAvg(csvToPandas(filename), float(hub), float(casing))))
    elif whichType == '1':
        print(radialAverage(csvToPandas(filename)))
    elif whichType == '2':
        print(circumferentialAverage(csvToPandas(filename)))
